...
_BUFF_HUD_LABELS = {
    ...
    "riposte": lambda e: f"RIPOSTE: counters any landed hit ({e.turns_remaining} turn(s) left)",
    "phasing": lambda e: f"PHASING: passes through blockers ({e.turns_remaining} turn(s) left)",
}
